classdef soBMP180 < matlab.System & coder.ExternalDependency
    % soBMP180.m
    ...
    methods (Access = protected)
        ...
        function [pres_Pa, absAlt_m, temp_C] = stepImpl(obj)
            ...
            if coder.target('Rtw')% done only for code gen
                ...
                coder.ceval('BMP180_Read', coder.wref(out));
            elseif ( coder.target('Sfun') )
                %
            end
    ...
    methods (Static)
        ...
        function updateBuildInfo(buildInfo, context)
            if context.isCodeGenTarget('rtw')                
                ...
                srcFiles = {'Wire.cpp', 'twi.c', 'Adafruit_BMP085.cpp', 'BMP180wrapper.cpp'};
